...
try:
    ...
    print("An exception occurred when opening input file and creating the invoices dictionary.")
...
try:
    ...
    print("An exception occurred when writing invoices dictionary into output file.")
