...
try:
    ...
    print("An exception occurred when opening input file and creating the product_info dictionary.")
...
try:
    ...
    print("An exception occurred when writing product_info dictionary into output file.")
